...
class ProfileSeeder extends Seeder
{
    ...
    {
        Profile::create([
			'bio' => 'Hallo, ik ben Hendrik, een 20-jarige student van het Koning Willem 1 College in Den Bosch. Momenteel studeer ik Software Developer en zit in het examen jaar. Naast mijn opleiding werk ik ook als verkoopmedewerker bij Hoogvliet Supermarkt. In mijn vrije tijd ben ik bezig met gamen, schoolwerk en zelf programmeren.',
